...
var arr_names: number[] = new Array(4)          //Array Object
...
var names: string[] = new Array("Mary", "Tom", "Jack", "Jill") //Array Constructor accepts comma separated values
...
let num11 = [7, 8, 9];
num11.forEach(function (value) { //calls a function for each element in the array
    console.log(value);
}); 
...
var destruct: number[] = [12, 13] //Array Destructuring : Breaking up the structure of an entity.
var [x2, y2] = destruct
console.log(x2)
console.log(y2)
...
var names: string[] = ["Mary", "Tom", "Jack", "Jill"];

function display_names(arr_names: string[]) {         //passing array to function
    for (var i = 0; i < arr_names.length; i++) {
        console.log(names[i])
    }
}
